...
if (strlen($_SESSION['ocasaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tbluploadass SET Marks=?, Remarks=? WHERE AssId=? AND UserID=?";
        $query = $conn->prepare($sql);
        $query->bind_param("ssss", $marks, $remarks, $asid, $uid);
        if ($query->execute()) {
                                ...
                                ?>
                                        ...
                                        <div class="row">
                                            <table class="table table-bordered table-hover data-tables">
                                                <tr>
                                                    <td colspan="4" style="text-align: center;color: blue">Submitted By <?php echo htmlentities($row['FullName']); ?> (Roll Number: <?php echo htmlentities($row['RollNumber']); ?>)</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered table-hover data-tables">
                                            <tr>
                                                <td colspan="6" style="text-align: center;color: blue"><strong>Submitted Assignment Details</strong></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <table class="table table-bordered table-hover data-tables">
                                                <tr>
                                                    ...
                                                    <?php if ($row['Marks'] == "") { ?>
                                                        <td colspan="2"><?php echo "Not Updated Yet"; ?></td>
                                                    <?php } else { ?>
                                                        <td colspan="6" style="text-align: center;"><?php echo $row['Remarks'] ?></td>
                                                    <?php } ?>
